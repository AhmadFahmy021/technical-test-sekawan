            ...
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="p-5">
                        ...
                        <form class="user" method="POST" action="{{ url('agree/login') }}">
                            @csrf
                        ...
                        <div class="row mt-4">
                            <div class="col-12 text-center">
                                <p class="text-muted mb-0">Don't have an account? <a href="{{ url('agree/register') }}" class="text-muted font-weight-medium ml-1"><b>Register</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
                    </div> <!-- end .padding-5 -->
