        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">Create Vehicle</h4>
                </div>
            </div>
        </div>
                        ...
                        <form method="POST" action="{{ url('admin/vehicle') }}">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('merkVehicle')
                                    is-invalid
                                @enderror" id="merkVehicle" name="merkVehicle" placeholder="Input Merk Vehicle">
                                @error('merkVehicle')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('typeVehicle')
                                    is-invalid
                                @enderror" id="typeVehicle" name="typeVehicle" placeholder="Input Vehicle Type">
                                @error('typeVehicle')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                  </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control @error('kilometersVehicle')
                                    is-invalid
                                @enderror" id="kilometersVehicle" name="kilometersVehicle" placeholder="Input Kilometers Vehicle">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('fuelOilVehicle')
                                    is-invalid
                                @enderror" id="fuelOilVehicle" name="fuelOilVehicle" placeholder="Input Type Of Fuel Oil">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control @error('seatVehicle')
                                    is-invalid
                                @enderror" id="seatVehicle" name="seatVehicle" placeholder="Input Seat Vehicle">
                                @error('seatVehicle')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                  </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="date" class="form-control @error('rapairDateVehicle')
                                    is-invalid
                                @enderror" id="repairDateVehicle" name="repairDateVehicle" placeholder="Input Repair Date Vehicle">
                            ...
                            <div class="form-group mb-3">
                                <button type="submit" class="btn btn-primary">Submit Create Vehicle</button>
                            </div>
                        </form>
                    </div>
                </div>
