...
@section('main')
        ...
        <div class="row">
            <div class="col-md-6 col-xl-3">
                <div class="card bg-primary border-primary">
                    <div class="card-body">
                        <div class="mb-4">
                            <h5 class="card-title mb-0 text-white">VIHECLE BOOKING </h5>
                        </div>
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card bg-success border-success">
                    <div class="card-body">
                        <div class="mb-4">
                            <h5 class="card-title mb-0 text-white">VEHICLE BOOKING APPROVED</h5>
                        </div>
                        <div class="row d-flex align-items-center mb-4">
                            <div class="col-8">
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card bg-warning border-warning">
                    <div class="card-body">
                        <div class="mb-4">
                            <h5 class="card-title mb-0 text-white">VEHICLE ORDER REJECTED</h5>
                        </div>
                        <div class="row d-flex align-items-center mb-4">
                            <div class="col-8">
                                <h2 class="d-flex align-items-center text-white mb-0">
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card bg-info border-info">
                    <div class="card-body">
                        <div class="mb-4">
                            <h5 class="card-title mb-0 text-white">TOTAL VEHICLES</h5>
                        </div>
                        <div class="row d-flex align-items-center mb-4">
                            <div class="col-8">
                                <h2 class="d-flex align-items-center text-white mb-0">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="dropdown float-right position-relative">
                            <select class="form-control" name="vehicle" onchange="findData(value)"
    ...
    <script>
        function findData(val) {
            $.ajax({
                type: "get",
                url: location.origin + "/admin/find",
                data: {
                    value: val
                },
                dataType: "JSON",
                success: function(data) {
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                label: 'Used Vehicle Data This Year',
                                data: data,
                                borderWidth: 1
                            }, ]
                        },
